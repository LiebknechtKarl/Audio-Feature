...
class AudioVideoDataset(Dataset):
    def __init__(self, audio_dir, video_dir, transform=None, audio_transform=None, max_frames=None):
        ...
        self.sample_ids = sorted([
            f.split(".")[0] for f in os.listdir(self.audio_dir) if f.endswith(".wav")
        ])
...
class DatasetSegmentation():
    ...
    def __init__(self,audio_dir , video_dir , target_frame_size = (128,128), test_radio = 0.15):
        self.audio_dir = audio_dir 
        self.video_dir = video_dir 
    ...
    def dataset_creation(self) :
        ...
        video_transform = transforms.Compose([
            transforms.Resize( self.target_frame_size ),
            transforms.ToTensor()
            ])     
    ...
    def segmentation(self):
        dataset = self.dataset_creation()


        # 计算拆分长度   15% 作为测试集
        total_size = len(dataset)
        test_size = int(self.test_radio * total_size)
...
if __name__ == "__main__":
    ...
    # audio_dir='/home/fu/Desktop/ubuntu_data/nlp/demo_55_audio_future/3_feature/CMLRdataset/audio_normal'
    # video_dir='/home/fu/Desktop/ubuntu_data/nlp/demo_55_audio_future/3_feature/CMLRdataset/video'
